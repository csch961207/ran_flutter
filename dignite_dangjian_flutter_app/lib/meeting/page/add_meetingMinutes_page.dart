...
class AddMeetingMinutesPage extends StatefulWidget {
  const AddMeetingMinutesPage({
    Key key,
  ...
  @override
  _AddMeetingMinutesPageState createState() => _AddMeetingMinutesPageState();
}

class _AddMeetingMinutesPageState extends State<AddMeetingMinutesPage> {
...
//                isShape: true,
              onPressed: () async {
                ...
                try {
                  ...
                  this.addMeetingMinutes.meetingId = widget.meetingId;
                  print(this.addMeetingMinutes.toJson());
                  String code = await MeetingRepository.postMeetingMinutes(
