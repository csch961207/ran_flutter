...
class AddPartyMemberPage extends StatefulWidget {
  @override
  _AddPartyMemberPageState createState() => _AddPartyMemberPageState();
}

class _AddPartyMemberPageState extends State<AddPartyMemberPage> {
  AddPartyMember _addPartyMember = new AddPartyMember();
  PartyMemberEdit _addPartyMemberEdit = new PartyMemberEdit();
  Enums genderType = new Enums(enumValues: [
    new EnumValue(name: '男', value: 1),
    new EnumValue(name: '女', value: 2),
  ]);
  ...
  void initState() {
    super.initState();
    this._addPartyMemberEdit.gender = 1;
    this._addPartyMemberEdit.partyMemberType = 1;
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ClickItem(
                            title: "性别",
                            content: genderType
                                .enumName(_addPartyMemberEdit.gender),
                ...
                try {
                  ...
                  String organizationUnitId =
                      Provider.of<DangjianViewModel>(context, listen: false)
                          .myOrganization
                          ?.organizationUnitId;
                  this._addPartyMember.organizationUnitId = organizationUnitId;
                  this._addPartyMember.edit = this._addPartyMemberEdit;
                  String code = await PartyMemberRepository.postPartyMembers(
