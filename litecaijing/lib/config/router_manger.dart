...
import 'package:litecaijing/ui/page/article/article_page.dart';
import 'package:litecaijing/ui/page/article/comments_list.dart';
import 'package:litecaijing/ui/page/blog_page.dart';
import 'package:litecaijing/ui/page/coin/coin_record_list_page.dart';
import 'package:litecaijing/ui/page/content_management_page.dart';
import 'package:litecaijing/ui/page/home.dart';
import 'package:litecaijing/ui/page/popular_page.dart';
import 'package:litecaijing/ui/page/readingRecordList_page.dart';
import 'package:litecaijing/ui/page/setting_page.dart';
import 'package:litecaijing/ui/page/splash.dart';
import 'package:litecaijing/ui/page/tab/tab_navigator.dart';
import 'package:litecaijing/ui/page/user/login_page.dart';
import 'package:litecaijing/ui/page/user/register_page.dart';
import 'package:litecaijing/ui/page/webview_page.dart';
import 'package:litecaijing/ui/widget/page_route_anim.dart';
...
//            fullscreenDialog: true, builder: (_) => HomePage());
      ...
      case RouteName.webView:
        ...
        return MaterialPageRoute(builder: (_) => WebViewPage(url: url,),fullscreenDialog:true);
      default:
        return CupertinoPageRoute(
            builder: (_) => Scaffold(
              body: Center(
