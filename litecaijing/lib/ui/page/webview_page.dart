...
import 'package:litecaijing/util/bottomSheet_utils.dart';
import 'package:litecaijing/util/string_utils.dart';
import 'package:litecaijing/util/theme_utils.dart';
import 'package:litecaijing/util/toast_util.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        backgroundColor: ThemeUtils.isDark(context)
            ...
            : Colors.white,
        iconTheme: IconThemeData(color: ThemeUtils.isDark(context) ? Colors.white : Colors.black),
        title: Text(
          //移除html标签
          StringUtils.removeHtmlLabel(title),
          overflow: TextOverflow.ellipsis,
          style: TextStyle(
              fontSize: 16, color: ThemeUtils.isDark(context) ? Colors.white : Colors.black, fontWeight: FontWeight.w600),
        ),
//        WebViewTitle(
//          title: title,
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: ThemeUtils.isDark(context)
                                      ? ThemeUtils
                                      .getBackgroundColor(
                                      context) : Color.fromRGBO(240, 240, 240, 1),
                                ),
                              ),
                              SizedBox(
                                height: 5,
