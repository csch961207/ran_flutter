...
import 'package:litecaijing/view_model/find_model.dart';
                                                  ...
                                                  Navigator.of(context)
                                                      .pushNamed(
                                                          RouteName
                                                              .articleDetail,
                                                          arguments:
                                                              model.headlines[0].media.id);
                                                },
                                                child: Text(
                                                  model.headlines[0].media.title,
                                                  maxLines: 2,
                                                  overflow:
                                                  ...
                                                  Navigator.of(context)
                                                      .pushNamed(
                                                          RouteName
                                                              .articleDetail,
                                                          arguments:
                                                              model.headlines[1].media.id);
                                                },
                                                child: Text(
                                                  model.headlines[1].media.title,
                                                  maxLines: 2,
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  style: TextStyle(
                                            ...
                                            child: InkWell(
                                              onTap: () {
                                                Navigator.of(context).pushNamed(
                                                    ...
                                                    arguments:
                                                        model.headlines[2].media.id);
                                              },
                                              child: Text(
                                                model.headlines[2].media.title,
                                                maxLines: 2,
                                                overflow: TextOverflow.ellipsis,
                                                style: TextStyle(
                                                    decoration:
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: InkWell(
                                            onTap: () {
                                              Navigator.of(context).pushNamed(
                                                  RouteName.articleDetail,
                                                  arguments: model.headlines[3].media.id);
                                            },
                                            child: Container(
                                              height: 90,
                                              padding: EdgeInsets.fromLTRB(
