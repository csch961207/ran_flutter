...
import 'package:litecaijing/config/resource_mananger.dart';
import 'package:litecaijing/config/router_manger.dart';
import 'package:litecaijing/generated/l10n.dart';
import 'package:litecaijing/provider/provider_widget.dart';
import 'package:litecaijing/ui/widget/app_bar.dart';
import 'package:litecaijing/ui/widget/bottom_clipper.dart';
import 'package:litecaijing/view_model/coin_model.dart';
import 'package:litecaijing/view_model/login_model.dart';
import 'package:litecaijing/view_model/theme_model.dart';
import 'package:litecaijing/view_model/user_model.dart';
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Column(children: <Widget>[
                            Text(
                          model.user != null ? model.user.userName : S.of(context).toSignIn,
      ...
      child: SliverList(
        delegate: SliverChildListDelegate([
          ListTile(
            title: Text('内容管理'),
            onTap: () {
              Navigator.of(context).pushNamed(RouteName.contentManagement);
            },
            leading: Icon(
              Icons.description,
              color: iconColor,
          ...
          ListTile(
            title: Text('浏览记录'),
            onTap: () {
              Navigator.of(context).pushNamed(RouteName.readingRecordList);
