...
import 'package:limeauto/ui/page/article/related_article_list.dart';
import 'package:limeauto/ui/widget/article_skeleton.dart';
import 'package:limeauto/ui/widget/like_count.dart';
...
import 'package:limeauto/utils/platform_utils.dart';
  ...
  userWeChatShare(BuildContext context, ArticleModel article) {
    SSDKMap params = SSDKMap()
      ..setGeneral(
          ...
          article.article.media.coverImages[0],
          null,
          "http://limeauto.com.cn/" + article.article.url,
          article.article.media.coverImages[0],
          null,
          null,
          null,
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            Share.share('【' + article.article.media.title + '】'"http://limeauto.com.cn/" + article.article.url,);
                          },
                          child: Row(
                            children: <Widget>[
