...
import 'package:limeauto/config/net/limeauto_api.dart';
...
import 'package:limeauto/service/http_api.dart';
import 'dart:convert';

class LimeAutoRepository {
  // 轮播
  ...
  static Future fetchHeadlines() async {
    ...
    FieldValues postFieldValue = entitie.fieldValues.firstWhere((fieldValue) =>
        fieldValue.fieldId == 'fd7bba7f-31cf-21e7-1ce0-39f9451502f0');
